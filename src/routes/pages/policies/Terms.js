...
export default function Terms() {
    return (
        <React.Fragment>
            ...
            <p>Our Terms of Service were last updated on December 26, 2022.</p>
            <p>
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        "Terms" or "Terms of Service") mean these Terms of
                        Service that form the entire agreement between You and
                        the Company regarding the use of the Service. This Terms
                        of Service Agreement was generated by{' '}
                ...
                <li>
                    <p>
                        <strong>"Website"</strong> refers to campus-maps,
            ...
            <p>
                ...
                your own risk. You understand that by using the Service You may
                be exposed to content that You may find offensive, indecent,
                incorrect or objectionable, and You agree that under no
                circumstances will the Company be liable in any way for any
                content, including any errors or omissions in any content, or
            ...
            <p>
                ...
                (dhakal.rakrish@gmail.com) and include in Your notice a detailed
            ...
            <p>
                ...
                (dhakal.rakrish@gmail.com). Upon receipt of a notification, the
            ...
            <ul>
                <li>By sending us an email: dhakal.rakrish@gmail.com</li>
            </ul>
            <p></p>
        </React.Fragment>
    );
